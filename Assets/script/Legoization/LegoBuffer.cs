...
public class LegoBuffer
{
	...
	public void draw (GameObject gameObject, List<Lego> legos, float size, Color color) {
		MeshFilter filter = gameObject.GetComponent< MeshFilter >();
		Mesh mesh = filter.mesh;
		mesh.Clear();
		
		foreach (Lego lego in legos) {
			Vector3 v = lego.getPosition();
			addLego (v.x,v.y,v.z, size, lego.getDimen(),lego.getType());
		}
